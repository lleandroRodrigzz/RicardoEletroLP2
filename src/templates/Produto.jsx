            ...
            <div id='botao-comprar'>
                <button
                    ...
                    type='button' onClick={() => {
                        ...
                        const produtoExiste = props.listaProdutosCarrinho.find(item => item.id === produtoAdicionado.id)
                        if (!produtoExiste) {
                            ...
                            window.alert("O produto de código " + props.produto.id + " ja está no seu carrinho !");
                        }
                    }}>
                    Comprar
                </button>
